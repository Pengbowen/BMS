...
function add() {
	if (!addData())
		return;
	var url = "answer/addCriteria.action";
...
<div class="share-content">
    <div class="share-box">
        <ul class="share-left">
            ...
            <li><a href="javascript:vido(0);" onclick="skip(1)" class="active-now">分享标准</a></li>
            <li><a href="javascript:vido(0);" onclick="skip(2)">我要标准</a></li>
            <li><a href="javascript:vido(0);" onclick="skip(0)">意见建议</a></li>
        </ul>
