...
<div class="current-position-box">
	<div class="current-position">
        ...
        <i class="icon icon-angle-right"></i><b> 管理标准体系表</b>
    </div>
</div>
<!--banner结束 -->
<div class="search-table">
	<iframe src="${pageContext.request.contextPath}/SST/standard-iframe.jsp?type=manage" height="580" frameborder="0" width="100%" marginwidth="0" marginheight="0" id="iframepage" onLoad="reinitIframe()"></iframe>
</div>
<!--底部开始 -->
