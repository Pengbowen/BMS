...
<div class="search-table">
	<iframe src="${pageContext.request.contextPath}/SST/standard-iframe.jsp?type=technical" height="580" scrolling="no" frameborder="0" width="100%" marginwidth="0" marginheight="0" id="iframepage" onLoad="reinitIframe()"></iframe>
</div>
<!--底部开始 -->
