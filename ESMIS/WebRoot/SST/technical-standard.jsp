...
<script src="${pageContext.request.contextPath}/SST/scripts/technical-standard.js" type="text/javascript"></script>
...
<body>
	...
	<div class="add-standard-box" id="add-standard-box" style="position:relative;display:block;">
    	<div class="add-title">技术标准体系表</div>
    </div>
    <!--bnt开始 -->
    <div style="position:absolute;left:50%;margin-left:-140px;display:none;" id="standard-bnt">
        <form>
            <input type="button" class="standard-bnt standard-bnt1" onclick="setItems(1)" value="设置层项目信息"/>
            <input type="button" onClick="setting(1)" class="standard-bnt standard-bnt2" value="设置体系表样式"/>
            <!-- 
