...
<script src="${pageContext.request.contextPath}/SST/scripts/manage-standard.js" type="text/javascript"></script>
...
<body>
	...
	<div class="add-standard-box" id="add-standard-box" style="position:relative;display:block;">
    	<div class="add-title">管理标准体系表</div>
    </div>
    <!--bnt开始 -->
    <div style="position:absolute;left:50%;margin-left:-160px;display:none;" id="standard-bnt">
        <form>
            <input type="button" class="standard-bnt standard-bnt1" onclick="setItems(2)" value="设置层项目信息"/>
            <input type="button" onClick="setting(2)" class="standard-bnt standard-bnt2" value="设置体系表样式"/>
            <!-- 
