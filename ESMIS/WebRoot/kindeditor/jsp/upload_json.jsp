 ...
 */
  String path = request.getContextPath();
	...
	if(request.getServerPort()!=80) basePath += ":"+request.getServerPort();
	basePath += path+"/";

//文件夹名
String filesName="uploadfiles/editor";

//文件保存目录路径
String savePath = pageContext.getServletContext().getRealPath("/"+filesName+"/") ;

//文件保存目录URL
String saveUrl  = request.getContextPath() +"/"+ filesName+"/";
