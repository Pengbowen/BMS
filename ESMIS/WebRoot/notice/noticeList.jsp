...
<html>
  <head>
	...
	<script src="${pageContext.request.contextPath}/notice/scripts/list.js" type="text/javascript"></script>
	
	<script type="text/javascript">
		var rootPath = "${pageContext.request.contextPath}/";
		var LoadDataUrl = rootPath + 'notice/searchNoticeByConditionAndPage.action';
		...
		$(function() {
			$('#' + gridviewId).datagrid({
				...
				columns : [ [//设置gridview的列信息*
				{
					...
					width : '270',
					align : 'left',
					formatter : noticeTitleFormatter
				}, {
					field : 'deadline',
					title : '截止时间',
					width : '150',
		...
		<div region="north" border="false"
			...
			<div style="float:left;">
				<span style="margin-left:10px;">标题：</span> 
					<input class="easyui-textbox" id="noticeTitle" name="noticeTitle" inQuery="true" operator="like" data-options="prompt:'请输入标题'" style="width:150px;height:26px" />
