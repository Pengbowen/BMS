...
},beforePageText:"第",afterPageText:"页 共{pages}页",displayMsg:"当前显示 {from} 到 {to}条记录 共 {total}条记录 ",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"此处不可为空.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_48d,blur:_491,mouseenter:_494,mouseleave:_497,click:function(e){
var t=$(e.data.target);
...
_aa6(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",cleanText:"clean",buttons:[{text:function(_abb){
