...
<div class="tabPanel">
    	<div class="sub-posit-cont" style="padding-top:36px;">
        	<a class="posit-a" href="${pageContext.request.contextPath}">首页</a> <i class="icon icon-angle-right" ></i>  <b id="title"> 错误提示</b>
     </div>
</div>
<!--content开始 -->
<div class="sub-contnew" style="min-height:550px;">
    ...
    <ul class="sub-content">
        ...
        <li class="sub-content-text" style="text-align:center;font-size:30px;">
        	<element>下载失败:${msg}</element></li>
        	<element style="display:block;text-align:center;margin-top:14px;"><a onclick="history.go(-1)" style="font-size:20px;">点击返回</a><element>
    </ul>
</div>
<!--content结束 -->
<!--底部开始 -->
