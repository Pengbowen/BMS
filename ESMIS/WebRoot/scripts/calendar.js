...
function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern,rtnFuncName) {
	this.beginYear = beginYear || 1900;
	this.endYear   = endYear   || (new Date().getFullYear()+20);
	...
	this.colors = {"bg_cur_day":"#666","bg_over":"#FFF","bg_out":"#482424"};
	this.resultFunc=rtnFuncName;
};
...
Calendar.prototype.draw = function() {
	...
	_cs[_cs.length] = ' <tr class="calendarName">';
	...
	_cs[_cs.length] = ' <tr class="calendarBtn">';
	...
	this.form.clearButton.onclick = function () {calendar.dateControl.value = "";calendar.hide();calendar.executeFunc();};
...
Calendar.prototype.bindWeek = function(e){
	if(e.className == "sun"){
		e.style.color = "#f00";
	}else if(e.className == "sat"){
		e.style.color = "#00f";
	}else{
		e.style.color = "#000";
	}
...
Calendar.prototype.show = function (dateControl,iWZStyle,popuControl) {
...
Calendar.prototype.getAbsPoint = function (e,cH){
	var x = e.offsetLeft;
	var y = e.offsetTop;
...
Calendar.prototype.executeFunc=function(){
	if(this.resultFunc!=null)
	{
		if(this.resultFunc!=''){
			try{
				eval(this.resultFunc)(calendar.dateControl);
			}catch(e){
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFF;padding:3px;border:1px solid #BBB;width:201px;height:210px;">');
...
__ci.document.writeln('body {font-size:12px;margin:0px;text-align:center;font-famliy:SimSun,"Times New Roman"}');
__ci.document.writeln('form {margin:0px;}');
__ci.document.writeln('select {font-size:12px;background-color:#FFF;border:1px solid #999;}');
__ci.document.writeln('table {border:0px solid #CCCCCC;background-color:#FCFCFC;padding:0;margin:0;}');
__ci.document.writeln('th {font-size:12px;height:21px;font-weight:normal;background-color:#FCFCFC;padding:0;margin:0;}');
__ci.document.writeln('tr.calendarName{font-size:12px;height:30px;}');
__ci.document.writeln('tr.calendarBtn{font-size:12px;height:36px;}');
__ci.document.writeln('tr.calendarBtn th{border-top:1px solid #FFCC33;}');
__ci.document.writeln('th.theader {font-weight:normal;background-color:#FFCC33;color:#333;width:28px;}');
__ci.document.writeln('select.year {width:64px;margin-right:6px;}');
__ci.document.writeln('select.month {width:61px;}');
__ci.document.writeln('td {height:21px;font-size:12px;text-align:center;padding:0;margin:0;}');
__ci.document.writeln('td.sat {color:#0000FF;background-color:#FFF;border-right:1px solid #FFCC33;}');
__ci.document.writeln('td.sun {color:#FF0000;background-color:#FFF;border-left:1px solid #FFCC33;}');
__ci.document.writeln('td.normal {color:#333;background-color:#FFF;}');
__ci.document.writeln('input.l {float:left;margin-left:1px;cursor:pointer;border:1px solid #999; width:19px;height:19px;background-color:#fff;}');
__ci.document.writeln('input.r {float:right;margin-right:1px;cursor:pointer;border:1px solid #999; width:19px;height:19px;background-color:#fff;}');
__ci.document.writeln('input.b {border:none; -moz-border-radius: 2px;  -webkit-border-radius: 2px; border-radius:2px;color:#fff;cursor:pointer;background-color:#aaa;width:59px;height:22px;line-height:23px;}');
__ci.document.writeln('input.b:hover {background-color:#482424;}');
__ci.document.writeln('-->');
...
var calendar=new Calendar(null, null, null, null, null, null,"calendarResultFunc");
//--> 
/**
...
document.onclick=function(evt){
	try{
    	...
    	if(calendar.dateControl !=src) calendar.hide();
    }catch(ex)
    {
