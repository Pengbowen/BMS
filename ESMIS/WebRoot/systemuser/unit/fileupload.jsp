...
<script type="text/javascript">       
	...
	Ext.onReady(function() {
				...
				var fp = new Ext.FormPanel(
						{
						    url: rootPath+"extjs/upload/uploadController.jsp?t="+ Math.random()+"&fileURL=images&fileName=logo",
							renderTo : 'fi-form',
							fileUpload : true,
							width : 500,
							frame : true,
	...
	function saveMessage() {
		...
		var url = "";
		var strData=$("#savedpath").val();
		var url = '<img src="/ESMIS/'+strData+'?aaa='+ Math.random()+'" alt="" />';
		window.parent.closeWin();
		window.parent.setCompanyUrl(url);
	}
