...
<script type="text/javascript">
	...
	function searchStandard(){
    	...
    	var likeSearch = $.trim($("#topLikeSearch").val());    	
    	if(likeSearch==""){
    		alert("请输入要查询的内容！");
    		return false;
    	}
	...
	$(document).ready(function() {
		//回车事件绑定
		$('#topLikeSearch').bind('keyup', function(event) {
			if (event.keyCode == "13") {
				//回车执行查询
				searchStandard();
			}
...
<header>
    <div class="header-box">         
        <ul class="header-left">
            ...
            <li class="nav">
            	<a target="_parent" href="${pageContext.request.contextPath}/" id="webIndex">首页</a>
        ...
        <ul class="header-right">
             <li class="search-panel">             	
              		<div class="search-panel-fields">
                		<input name="topLikeSearch" id="topLikeSearch" type="text" value="${likeSearch}" title="请输入内容，按回车搜索" placeholder="请输入内容，按回车搜索" class="search-box"/>
              		</div>
              	<i class="icon icon-search"></i>
              	<!-- <span class="search-icon-count">705766 Icons</span> -->            	
             </li>
