...
/**
 * 
 * TODO 友情链接condition分页查询
 *
 * @author zlc
 * @date 2016-8-24 上午10:20:59
 */
...
private static final long serialVersionUID = 1L;
    ...
    public void search(){
        ...
        int count = blogrollService.getTotalCount(cond);
        List<SingleBlogroll> list = new ArrayList<SingleBlogroll>();
        list = blogrollService.selectByConditionAndPage(getCurrentPage(),getLinesOfPage(), cond, null);
