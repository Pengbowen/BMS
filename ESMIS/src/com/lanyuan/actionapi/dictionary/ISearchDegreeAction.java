...
public class ISearchDegreeAction  extends ResultSearchMapAction{
private static final long serialVersionUID = 1L;
	...
	public String execute()
	{
		...
		cond.addWithAnd(new ConditionNormal(ServiceDictionaryData.MappingList.dictionaryid.name(),"1002"));
