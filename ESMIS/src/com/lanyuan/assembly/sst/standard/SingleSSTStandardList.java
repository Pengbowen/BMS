...
import com.lanyuan.assembly.standardlibrary.EntityStandardLibrary;
 ...
 */
public class SingleSSTStandardList {
	...
	public String toString() {
		return "SingleSSTStandardList [standardNo=" + standardNo
				+ ", standardName=" + standardName + ", standardNameEN="
				+ standardNameEN + ", subjectWords=" + subjectWords
				+ ", SSTLoaction=" + SSTLoaction + ", adoptIS=" + adoptIS
				+ ", adoptionDegree=" + adoptionDegree + ", standardCategory="
				+ standardCategory + ", standardCategoryName="
				+ standardCategoryName + ", approvedUnit=" + approvedUnit
				+ ", approvedDate=" + approvedDate + ", effectiveDate="
				+ effectiveDate + ", proposedUnit=" + proposedUnit
				+ ", draftedUnit=" + draftedUnit + ", majorDrafters="
				+ majorDrafters + ", standardClassNo=" + standardClassNo
				+ ", standardKindNo=" + standardKindNo + ", applicableMajor="
				+ applicableMajor + ", newStandardId=" + newStandardId
				+ ", newStandardNo=" + newStandardNo + ", oldStandardId="
				+ oldStandardId + ", oldStandardNo=" + oldStandardNo
				+ ", explaintd=" + explaintd + ", remark=" + remark
				+ ", effectiveState=" + effectiveState + ", upgradeVersion="
				+ upgradeVersion + ", upgradeUser=" + upgradeUser
				+ ", upgradeDate=" + upgradeDate + ", dataSource=" + dataSource
				+ ", filePath=" + filePath + ", sharePeople=" + sharePeople
				+ ", browseVolume=" + browseVolume + ", creator=" + creator
				+ ", creatorName=" + creatorName + ", createTime=" + createTime
				+ ", createIP=" + createIP + ", sSTId=" + sSTId + ", layerNo="
				+ layerNo + ", layerItemId=" + layerItemId + ", subClassId="
				+ subClassId + ", standardId=" + standardId + ", displayOrder="
				+ displayOrder + ", modifyer=" + modifyer + ", modifyerName="
				+ modifyerName + ", modifyTime=" + modifyTime + ", modifyIP="
				+ modifyIP + "]";
	}
